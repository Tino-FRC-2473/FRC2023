...
public class PhotonCameraWrapper {
	...
	public PhotonCameraWrapper() {
		...
		atList.add(new AprilTag(3, new Pose3d(AprilTagConstants.APRILTAG_3_X_METERS,
		...
		atList.add(new AprilTag(4, new Pose3d(AprilTagConstants.APRILTAG_4_X_METERS,
			AprilTagConstants.APRILTAG_4_Y_METERS, AprilTagConstants.APRILTAG_4_HEIGHT_METERS,
			new Rotation3d(4, 0, AprilTagConstants.APRILTAG_4_ANGLE_RADIANS))));

		atList.add(new AprilTag(5, new Pose3d(AprilTagConstants.APRILTAG_5_X_METERS,
		...
		atList.add(new AprilTag(6, new Pose3d(AprilTagConstants.APRILTAG_6_X_METERS,
		...
		atList.add(new AprilTag(7, new Pose3d(AprilTagConstants.APRILTAG_7_X_METERS,
		...
		atList.add(new AprilTag(8, new Pose3d(AprilTagConstants.APRILTAG_8_X_METERS,
