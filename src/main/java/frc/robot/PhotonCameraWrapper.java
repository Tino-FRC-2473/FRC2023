...
public class PhotonCameraWrapper {
	...
	public Optional<EstimatedRobotPose> getEstimatedGlobalPose() {
		...
		// Pose3d pose = (new Pose3d(new
		// Translation3d(AprilTagConstants.APRILTAG_1_X_METERS,
		// AprilTagConstants.APRILTAG_1_Y_METERS,
		// AprilTagConstants.APRILTAG_1_HEIGHT_METERS), new
		// Rotation3d(0,0,AprilTagConstants.APRILTAG_1_ANGLE_RADIANS))).transformBy(camToTarget.inverse());
	...
	/**
	 * @return Returns a distance in meters from the closest cone and -1 if there
	 *         are no cones.
	 */
	...
	/**
	 * @return Returns a distance in meters from the closest cube and -1 if there
	 *         are no cubes.
	 */
